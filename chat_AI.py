...
Data = st.Page(page='\views\Table_Data.py',title='Data', icon='📅')
...
graph = st.Page(page='\views\Graph_data.py',title='Chat_bot', icon='📊')
test_data = st.Page(page='\views\Table_Data.py',title='Chat_bot', icon='📊')
pg = st.navigation(
